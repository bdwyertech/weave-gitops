...
This is a webhook used to validate terraform plans. It is mainly used by the [TF-Controller](https://github.com/flux-iac/tofu-controller) to enforce policies on terraform plans
