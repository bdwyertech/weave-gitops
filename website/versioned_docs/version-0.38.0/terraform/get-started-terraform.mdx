...
To set up the [Terraform Controller](https://github.com/flux-iac/tofu-controller) (TF-Controller), follow the steps in the preflight checks. Here is a summary of what you will need to do:
...
please see [this chart Readme](https://github.com/flux-iac/tofu-controller/tree/main/charts/tf-controller#tf-controller-for-flux).
