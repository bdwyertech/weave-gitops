...
LDFLAGS?=-X github.com/bdwyertech/weave-gitops/cmd/gitops/version.Branch=$(BRANCH) \
				 -X github.com/bdwyertech/weave-gitops/cmd/gitops/version.BuildTime=$(BUILD_TIME) \
				 -X github.com/bdwyertech/weave-gitops/cmd/gitops/version.GitCommit=$(GIT_COMMIT) \
				 -X github.com/bdwyertech/weave-gitops/cmd/gitops/version.Version=$(VERSION) \
				 -X github.com/bdwyertech/weave-gitops/pkg/version.FluxVersion=$(FLUX_VERSION) \
				 -X github.com/bdwyertech/weave-gitops/pkg/analytics.Tier=$(TIER) \
				 -X github.com/bdwyertech/weave-gitops/core/server.Branch=$(BRANCH) \
				 -X github.com/bdwyertech/weave-gitops/core/server.Buildtime=$(BUILD_TIME) \
				 -X github.com/bdwyertech/weave-gitops/core/server.GitCommit=$(GIT_COMMIT) \
				 -X github.com/bdwyertech/weave-gitops/core/server.Version=$(VERSION) \
				 -X github.com/bdwyertech/weave-gitops/cmd/gitops/beta/run.HelmChartVersion=$(CHART_VERSION)
